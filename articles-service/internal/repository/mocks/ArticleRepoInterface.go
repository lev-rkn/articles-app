...
// ArticleRepoInterface is an autogenerated mock type for the ArticleRepoInterface type
type ArticleRepoInterface struct {
	mock.Mock
}

// Create provides a mock function with given fields: ad
func (_m *ArticleRepoInterface) Create(ad *models.Article) (int, error) {
	ret := _m.Called(ad)
...
func (_m *ArticleRepoInterface) GetOne(id int) (*models.Article, error) {
	ret := _m.Called(id)
...
// NewArticleRepoInterface creates a new instance of ArticleRepoInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewArticleRepoInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *ArticleRepoInterface {
	mock := &ArticleRepoInterface{}
	mock.Mock.Test(t)
